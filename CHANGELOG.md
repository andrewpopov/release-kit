...
- aggregate verification now proves build freshness and release readiness
...
- slow git-subprocess hygiene tests now have enough time to assert their intended failures
